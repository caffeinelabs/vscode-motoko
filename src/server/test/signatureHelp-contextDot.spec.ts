...
describe('signatureHelp contextDot', () => {
    ...
    test('f1: type ( — self is the only param, no visible params', async () => {
        ...
        expect(result!.signatures[0].documentation).toEqual({
            kind: 'markdown',
            value: 'Returns the data value from the object.',
        });
    ...
    test('f2: type ( — shows amount as 1st visible param', async () => {
        ...
        expect(result!.signatures[0].documentation).toEqual({
            kind: 'markdown',
            value: 'Adds amount to the data and returns the result.',
        });
    ...
    test('f3: type ( — shows prefix as 1st visible param', async () => {
        ...
        expect(result!.signatures[0].documentation).toEqual({
            kind: 'markdown',
            value: 'Combines text with the data, repeated count times.',
        });
